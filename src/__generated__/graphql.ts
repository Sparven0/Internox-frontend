...
export type GetImapCredentialsQuery = {
  getImapCredentials?: Array<{
    __typename: "ImapCredential";
    id: string;
    user_id: string;
    imap_host: string;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "companyDomain" },
          },
          type: {
            kind: "NonNullType",
            type: {
...
>;
export const OnboardCompanyDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  OnboardCompanyMutation,
  OnboardCompanyMutationVariables
>;
export const CreateCompanyAdminDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CreateCompanyAdmin" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  CreateCompanyAdminMutation,
  CreateCompanyAdminMutationVariables
>;
...
export const GetCompanyByNameDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetCompanyByName" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "name" } },
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetUsersByCompanyId" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
export const GetImapCredentialsDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetImapCredentials" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "imap_host" } },
                { kind: "Field", name: { kind: "Name", value: "imap_port" } },
                {
                  kind: "Field",
  ...
  GetImapCredentialsQuery,
  GetImapCredentialsQueryVariables
>;
export const GetFortnoxDataDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetFortnoxData" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<GetFortnoxDataQuery, GetFortnoxDataQueryVariables>;
